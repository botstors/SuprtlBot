...
bot.command(['start', 'help'], async (ctx) => {
    ...
    const replyMarkup = await {
        inline_keyboard: [
            ...
            [{ text: 'فيديو لطريقة عمل البوت', url: "https://t.me/TechCharmDeals/5462" }],
            [{ text: '🌟 اجمع العملات من هنا🌟', url: "https://s.click.aliexpress.com/e/_DDyHLmz" }],
...
مرحبًا بك في بوت Tech Charm (BestPrice)

مهمة هذا البوت معرفة أقل سعر للمنتج المراد شراءه 😍 حيث يعطيك 3 روابط:

        ✅️ رابط خصم العملات
 حيث يقوم بزيادة خصمـالعملات من 1%-2% لتصل حتى الى 85% في بعض المنتجات
        ✅️ رابط عروض السوبر 🔥
        ✅️ رابط العرض المحدود 🔥

🔹️ انسخ رابط المنتج من aliexpress وضعه في البوت وقارن بين الروابط الثلاثة واشتري بأقل سعر وقم بتثبيت البوت (épinglée) لتسهيل استعماله.

🔹️ واهم شيء تقوم بجمع العملات يوميا من تطبيق aliexpress
يمكنك جمعها من هنا:
https://s.click.aliexpress.com/e/_DDyHLmz`;
